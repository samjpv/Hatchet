...
#### 3. Finally, the program will passively refresh the program at a rate corresponding to that inputted by the user, and will purchase the product if/when the 'Add to cart' button becomes active.<br/>
